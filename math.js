...
function makeCanvas(canvasId) {
    ...
    const drawScreen = function () {
        ...
        g.lineWidth = 1;
        let scale = 10;
        const { penta, starNew } = iface(g, scale, shapeMode.shapeMode);
...
function drawSecondInflation(id) {
    ...
    function drawScreen() {
        ...
        g.lineWidth = 1;
        let scale = 5;
        const { starNew, penta } = iface(g, scale, shapeMode.shapeMode);
...
function drawGeneric123(id) {
    ...
    g.lineWidth = 1;
    let scale = 10;
    const { penta, starNew, decaNew } = iface(g, scale, shapeMode.shapeMode);
